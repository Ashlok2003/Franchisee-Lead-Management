    ...
    return (
        <div className="bulk-verification-page">
            ...
            <p className="page-description">
                Verify multiple leads at once to improve data quality
            </p>
                            ...
                            {Array.isArray(leads) && leads.length > 0 ? (
                                leads.map((lead) => (
                                    <tr key={lead.id}>
                                        ...
                                        <td
                                            className={`lead-interest ${lead.leadType?.toLowerCase().replace(' ', '-') || 'unknown'}`}
                                        >
                                            {lead.leadType || 'Unknown'}
                                        </td>
                                        <td
                                            className={`lead-status ${lead.status?.toLowerCase().replace(' ', '-') || 'pending'}`}
                                        >
                                            {lead.status || 'Pending'}
                                        </td>
                                        <td className="lead-issue">
                                            {lead.notes || lead.issue || 'N/A'}
                                        </td>
