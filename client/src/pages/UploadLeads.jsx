        ...
        <div className="upload-leads-container">
            ...
            {activeTab === 'existing' && (
                <div className="upload-section">
                    ...
                    <p>
                        Upload your existing leads database in CSV format. Make sure your file
                ...
                <div className="new-lead-content">
                    ...
                    {activeNewLeadSubTab === 'uploadCsv' && (
                        <div className="upload-section">
                            <h2>CSV File Upload</h2>
                            <p>
                                Upload your new leads database in CSV format. Make sure your file
                                follows the required template structure.
                            </p>
                            ...
                            <button className="download-template-btn" onClick={downloadCSV}>
                                Download Template
                            </button>
                        ...
                        <div className="lead-form-container">
                            <div className="form-header">
                                ...
                                <div className="form-actions">
                                    <button className="back-btn" onClick={goBackToLeads}>
                                        Back to Leads
                                    </button>
                                    <button
                                        className="save-btn"
                            ...
                            <form onSubmit={handleSubmitLead}>
                                <div className="form-section">
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group">
                                            <label htmlFor="franchiseDeveloper">
                                                Franchise Developer Name
                                            </label>
                                            <input
                                                type="text"
                                            ...
                                            <div className="toggle-switch">
                                                ...
                                                <label htmlFor="isUpdated" className="toggle-label">
                                                    <span className="toggle-text">
                                                        Mark if lead information has been updated
                                                    </span>
                                                </label>
                                            </div>
                                        </div>
