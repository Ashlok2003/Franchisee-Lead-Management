...
const LeadsManagement = () => {
    ...
    // Lead source options
    const leadSourceOptions = ['Website', 'Exhibition', 'Referral', 'Social Media'];
    ...
    useEffect(() => {
        const fetchLeads = async () => {
            ...
            try {
                ...
                if (leadUpdateStatusFilter)
                    params.append('leadsUpdateStatus', leadUpdateStatusFilter);
    ...
    const addCustomSource = () => {
        if (
            newSource &&
            !customSources.includes(newSource) &&
            !leadSourceOptions.includes(newSource)
        ) {
    ...
    const handleAddSourceFromDropdown = () => {
        if (
            newSourceInput &&
            !customSources.includes(newSourceInput) &&
            !leadSourceOptions.includes(newSourceInput)
        ) {
    ...
    const handleSaveClick = async () => {
        try {
            ...
            setLeads(leads.map((lead) => (lead.id === selectedLead.id ? editFormData : lead)));
            ...
            <table className="leads-table">
                ...
                <tbody>
                    {leads.length > 0 ? (
                        ...
                        <tr>
                            <td colSpan="12" className="no-leads">
                                No leads found
                            </td>
                        </tr>
                    )}
    ...
    return (
        <div className="leads-management-page">
            ...
            <div className="leads-table-container">{renderLeadsTable()}</div>
