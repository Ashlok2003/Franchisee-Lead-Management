                    ...
                    <div className="quick-actions">
                        ...
                        <div className="action-buttons">
                            <button
                                ...
                                onClick={() => setActivePage('upload-leads')}
                            >
                    ...
                    <div className="follow-ups-table">
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <span className="user-icon">👤</span> Rahul Sharma
                                    </td>
                                    <td>High Interest</td>
                                    <td>WhatsApp</td>
                                    <td>Today, 2:00 PM</td>
                                ...
                                <tr>
                                    <td>
                                        <span className="user-icon">👤</span> Priya Patel
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <span className="user-icon">👤</span> Amit Kumar
                                    </td>
                                    <td>Low Interest</td>
                                    <td>Email</td>
                                ...
                                <tr>
                                    <td>
                                        <span className="user-icon">👤</span> Neha Singh
                                    </td>
                                    <td>High Interest</td>
                                    <td>WhatsApp</td>
