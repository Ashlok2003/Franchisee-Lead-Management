      ...
      <nav className="sidebar-nav">
        <div className="nav-item franchise-item">
          <button
            ...
            onClick={() => {
              handleNavClick("franchise-management");
              setFranchiseExpanded(!franchiseExpanded); // Toggle expansion when clicking on the main button
            }}
          >
          ...
          {franchiseExpanded && (
             <><div className="nav-item">
              ...
              <div className="nav-item">
                <button
                  className={`nav-button ${activePage === "campaign" ? "active" : ""}`}
